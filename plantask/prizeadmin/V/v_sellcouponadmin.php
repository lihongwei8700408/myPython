<?php
	global $_SELLER;
	$upd = WEB_SHOPADMIN.'/index.php?c=addproduct';
           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                           <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=couponadmin';?>">全部代金券</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=couponadmin&other=oncouponadmin';?>" >上架中</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=couponadmin&other=offcouponadmin';?>">未上架</a><a  class="curr" href="<?php echo WEB_SHOPADMIN.'/index.php?c=couponadmin&other=sellcouponadmin';?>">已卖出</a>	
                    </div>
					<div class="userTitle">
                    	<span>已卖出</span>
                    </div>
