           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                            <a class="curr" href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallcouponadmin';?>">全部代金券</a>
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <tbody>
                        <?php  $res=CouponList('',$_SELLER->SellerId); echo  VwList($res,$template)?> 
...
$('.del').click(function(){
	...
	$.post("<?php echo WEB_SHOPADMIN.'/index.php?c=mallcouponadmin&other=deletegoods';?>",{Id:id},function(date){
