<?php
	...
	$del = WEB_SHOPADMIN.'/index.php?c=addcoupon&other=deletegoods';
	$template="
 		<tr>
                ...
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                           <a  href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallcouponadmin';?>">全部代金券</a>
                            <a  class="curr"href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallcouponadmin&other=oncouponadmin';?>" >上架中</a>
                            ...
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallcouponadmin&other=autooffcouponadmin';?>">售完下架</a>
                    </div>
					<div class="userTitle">
                    	<span>上架中</span>
                    </div>
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <tbody>
                        <?php  $res=CouponList('(2)',$_SELLER->SellerId); echo  VwList($res,$template)?> 
...
$('.del').click(function(){
	...
	$.post("<?php echo WEB_SHOPADMIN.'/index.php?c=mallcouponadmin&other=downgoods';?>",{Id:id},function(date){
