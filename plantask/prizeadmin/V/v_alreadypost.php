           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=prizerecord'?>">全部获奖记录</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=prizerecord&other=nopost'?>">待发货奖品记录</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=prizerecord&other=alreadypost'?>" class="curr">已发货奖品记录</a>	
                    </div>
					<div class="userTitle">
                    	<span>已发货奖品记录</span>
                    </div>
                    <div class="sellerSearch">
                     <div>
						...
						<input type="hidden" value='alreadypost' name="other"/>
					   <?php 
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <tbody>
                        <?php  $res=GameList('1'); echo  VwList($res,$template)?> 
