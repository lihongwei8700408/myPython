<?php 
	...
	$template="
		...
		&nbsp;&nbsp;成交时间：<!--{VmSContent('CreatTime[11]:_fun->DealTime',\$vm_data)}-->&nbsp;&nbsp;订单状态：<!--{VmSContent('State[11]:_fun->OrderState',\$vm_data)}-->&nbsp;&nbsp;买家：<!--{VmSContent('MemberId[11]:_fun->GetMemberName',\$vm_data)}-->&nbsp;&nbsp;订单金额：<!--{VmSContent('OrderPrice[]',\$vm_data)}-->&nbsp;&nbsp;积分抵扣：<!--{VmSContent('UserPoint[11]',\$vm_data)}-->&nbsp;&nbsp;<!--{VmSContent('Id[11]:_fun->OrderDeal',\$vm_data)}--></th></tr>
 		<tr>
          ...
          <div class="userRight">
                <div class="uRight_user">
				    <div class="user_Eva_botTab">
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=order'?>" class="curr">全部订单</a>
                            ...
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=order&other=norevieworder'?>">待评价订单</a>
                    ...
                    <table class="bought_table">
                        <thead>
 		                ...
 		                <tbody>
                        <?php  $res=OrderList('',$_SELLER->SellerId);
...
$('.sellbutton').click(function(){
	...
	if(s==4){
		$.post("<?php echo WEB_SHOPADMIN.'/index.php?c=order&other=deleteorder';?>",{Id:id},function(date){
		...
		$.post("<?php echo WEB_SHOPADMIN.'/index.php?c=order&other=reciveorder';?>",{Id:id},function(date){
		...
		$.post("<?php echo WEB_SHOPADMIN.'/index.php?c=order&other=confirmorder';?>",{Id:id},function(date){
