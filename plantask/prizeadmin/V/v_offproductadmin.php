<?php
	...
	$template="
		...
		<a class='del' href='javascript:;s' data-id=<!--{VmSContent('Id[11]',\$vm_data)}-->>上架</a></td>
    	</tr>";
           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                            ...
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=offproductadmin'?>" class="curr">未上架</a>
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <thead>
                            ...
                            <tr><th width=""  colspan="9" align="left"><input class='check-one check_all' type='checkbox' />全选<a  href="javascript:;" class="sellbutton upall">上架</a></th></tr>
                        ...
                        <tbody>
                        <?php  $res=ProductList('(1)',$_SELLER->SellerId); echo  VwList($res,$template)?> 
...
$('.del').click(function(){
	...
	$.post("<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=upbusiness';?>",{Id:id},function(date){
