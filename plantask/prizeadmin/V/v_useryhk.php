...
<div class="content" style="margin-left:10px;">
         ...
         <div class="cLineB" style="width:800px;"><h4>绑定银行卡</h4></div>
          <form method="post" action="<?php echo WEB_SHOPADMIN.'/index.php?c=useryhk';?>" enctype="multipart/form-data">
          <div class="msgWrap">
              ...
              <thead>
				...
				<tr>
                  <th><span class="red">*</span>姓名：</th>
                   <td><input type="text" required="" name="BankOpenName"  class="px" tabindex="1" size="35"></td>
                </tr>
              </thead>
              <tbody>
                 <tr>
                  <th><span class="red">*</span>银行卡号：</th>
                   <td><input type="text" required="" name="BankCard"  class="px" tabindex="1" size="35"></td>
                </tr>
                <tr>
