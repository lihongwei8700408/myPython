           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                            ...
                            <a  class="curr" href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallcouponadmin&other=offcouponadmin';?>">未上架</a>
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <tbody>
                        <?php  $res=CouponList('(1)',$_SELLER->SellerId); echo  VwList($res,$template)?> 
