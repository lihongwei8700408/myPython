           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin'?>" class="curr">全部实物商品</a>
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <thead>
                            ...
                            <tr><th width=""  colspan="9" align="left"><input class='check-one check_all' type='checkbox' />全选<a href="javascript:;" class="sellbutton delall">删除</a><a  href="javascript:;" class="sellbutton upall">上架</a><a href="javascript:;" class="sellbutton downall">下架</a></th></tr>
                        ...
                        <tbody>
                        <?php  $res=ProductList('',$_SELLER->SellerId); echo  VwList($res,$template)?> 
...
$('.delall').click(function(){
				...
				if(data.length > 0){
					$.post('<?php echo WEB_SHOPADMIN.'/index.php?c=business&other=deletegoods';?>',{'Id':data}, function (date) {	
...
$('.upall').click(function(){
				...
				if(data.length > 0){
					...
					$.post('<?php echo WEB_SHOPADMIN.'/index.php?c=business&other=upgoods';?>',{'Id':data}, function (date) {	
...
$('.downall').click(function(){
				...
				if(data.length > 0){
					$.post('<?php echo WEB_SHOPADMIN.'/index.php?c=business&other=downgoods';?>',{'Id':data}, function (date) {	
