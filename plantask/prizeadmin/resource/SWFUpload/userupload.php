...
// Settings
	...
	$save_path = '../../user/AUTH/idcard/'.$path.'/';
...
// Validate that we won't over-write an existing file
	/*  if (file_exists($save_path.$file_name)) {
		  ...
		  $result =unlink ($save_path.$file_name); 
			 if($result == true){
			echo 'http://pic1.888.com/idcard/'.$path.'/'.$file_name;
			exit
	        }
			else{
			echo  "删除失败";
