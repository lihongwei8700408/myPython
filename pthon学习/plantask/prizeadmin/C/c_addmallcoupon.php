<?php
	function actionV_index(){
		global $_SELLER;
	     if(isset($_GET['Id'])&&!empty($_GET['Id'])){
			$other = 'Images,Content,StartTime,EndTime,Worth';
			$update = GetUpdateMallData('*','cl_mall_goods','Id='.$_GET['Id'],$other,'cl_mall_coupons','GoodsId='.$_GET['Id']);
		
		}
		$layout_content = './V/v_addmallcoupon.php';
	...
	if(isset($_POST['submit'])){
		...
		if($_POST['update']){
			...
			$prm->update = glurSql($_POST,array('update','Content','Images','StartTime','EndTime','AddTime','Worth'),',');
