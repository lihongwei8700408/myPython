<?php 
	...
	$template="
		...
		&nbsp;&nbsp;成交时间：<!--{VmSContent('AddTime[11]:_fun->DealTime',\$vm_data)}-->&nbsp;&nbsp;订单状态：<!--{VmSContent('State[11]:_fun->OrderCheck',\$vm_data)}-->&nbsp;&nbsp;买家：<!--{VmSContent('MemberId[11]',\$vm_data)}-->&nbsp;&nbsp;支付金额：<!--{VmSContent('OrderPrice[]',\$vm_data)}-->&nbsp;&nbsp;积分抵扣：<!--{VmSContent('UserPoint[11]',\$vm_data)}-->&nbsp;&nbsp;<a href='#'>删除</a></th></tr>
 		<tr>
          ...
          <div class="userRight">
                <div class="uRight_user">
				    <div class="user_Eva_botTab">
                            ...
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=morder&other=postmallorder';?>" >待发货订单</a>
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=morder&other=reviewmallorder';?>" class="curr">待评价订单</a>
                    ...
                    <table class="bought_table">
                        <thead>
 		                ...
 		                <tbody>
                        <?php  $res=MallOrderList('4',$_SELLER->SellerId);
