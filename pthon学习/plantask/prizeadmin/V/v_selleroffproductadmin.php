<?php
	global $_SELLER;
	$upd = WEB_SHOPADMIN.'/index.php?c=addmallproduct';
	$template="
 		<tr>
    	...
    	<td align='center'><!--{VmSContent('ParentId[11]:_fun->GetClassName',\$vm_data)}-->——<!--{VmSContent('ClassId[11]:_fun->GetClassName',\$vm_data)}--></td>
		...
		<a class='del' href='javascript:;' data-id=<!--{VmSContent('Id[11]',\$vm_data)}-->>上架</a></td>
    	</tr>";
           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin'?>">全部实物商品</a>
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=onproductadmin'?>" >上架中</a>
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=offproductadmin'?>">未上架</a>
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=selleroffproductadmin'?>" class="curr">手动下架</a>
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=autooffproductadmin'?>">售完下架</a>		
                    </div>
					<div class="userTitle">
                    	<span>手动下架</span>
                    </div>
                    ...
                    <div class="sellerSearch">
                     <div>
						...
						<input type="hidden" value='mallproductadmin' name="c"/>
					   <?php 
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <thead>
                            ...
                            <tr><th width=""  colspan="9" align="left"><input class='check-one check_all' type='checkbox' />全选<a href="javascript:;" class="sellbutton delall">删除</a><a  href="javascript:;" class="sellbutton upall">上架</a></th></tr>
                        ...
                        <tbody>
                        <?php  $res=ProductList('(4)',$_SELLER->SellerId); echo  VwList($res,$template)?> 
...
$('.del').click(function(){
	...
	$.post("<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=upgoods';?>",{Id:id},function(date){
...
$('.delall').click(function(){
				...
				if(data.length > 0){
					$.post('<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=deletegoods';?>',{'Id':data}, function (date) {	
...
$('.upall').click(function(){
				...
				if(data.length > 0){
					...
					$.post('<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=upgoods';?>',{'Id':data}, function (date) {	
