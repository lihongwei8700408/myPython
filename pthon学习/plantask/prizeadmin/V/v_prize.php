           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=prize'?>" class="curr">全部奖品</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=prize&other=real'?>">实物奖品</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=prize&other=virtual'?>">虚拟奖品</a>	
                    </div>
					<div class="userTitle">
                    	<span>全部奖品</span>
                    </div>
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <tbody>
                        <?php  $res=PrizeList('Id!=10'); echo  VwList($res,$template)?> 
