           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=chargerecord'?>">全部充值记录</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=chargerecord&other=suc'?>" class="curr">已成功记录</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=chargerecord&other=return'?>">等待退款记录</a>	
                    </div>
					<div class="userTitle">
                    	<span>已成功记录</span>
                    </div>
                    <div class="sellerSearch">
                     <div>
						...
						<input type="hidden" value='suc' name="other"/>
					   <?php 
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <tbody>
                        <?php  $res=ChargeRecordList('3','2'); echo  VwList($res,$template)?> 
