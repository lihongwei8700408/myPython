          ...
          <div class="userRight">
                <div class="uRight_user">
				    <div class="user_Eva_botTab">
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=usercount';?>" class="curr">收支明细</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=usercount&other=accountadd';?>">收入明细</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=usercount&other=accountdrop';?>">支出明细</a>		
                    </div>
					<div class="userTitle">
                    	<span>收支明细</span>
                    </div>
