          ...
          <div class="userRight">
                <div class="uRight_user">
				    <div class="user_Eva_botTab">
                            ...
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=morder&other=closemallorder';?>" class="curr">交易关闭</a>		
                    </div>
					<div class="userTitle">
                    	<span>交易关闭订单</span>
                    </div>
                    ...
                    <table class="bought_table">
                        <thead>
 		                ...
 		                <tbody>
                        <?php  $res=MallOrderList('6',$_SELLER->SellerId);
...
$('.sellbutton').click(function(){
	...
	$.post("<?php echo WEB_SHOPADMIN.'/index.php?c=morder&other=deleteorder';?>",{Id:id},function(date){
