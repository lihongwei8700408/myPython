           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=prize'?>">全部奖品</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=prize&other=real'?>">实物奖品</a><a href="<?php echo WEB_SHOPADMIN.'/index.php?c=prize&other=virtual'?>" class="curr">虚拟奖品</a>	
                    </div>
					<div class="userTitle">
                    	<span>虚拟奖品</span>
                    </div>
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <tbody>
                        <?php  $res=PrizeList('Id = 9 OR Id = 6'); echo  VwList($res,$template)?> 
