<?php
	...
	$template="
		...
		<a class='del' href='javascript:;' data-id=<!--{VmSContent('Id[11]',\$vm_data)}-->>下架</a></td>
    	</tr>";
           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                            ...
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=onproductadmin'?>" class="curr">上架中</a>
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <thead>
                            ...
                            <tr><th width=""  colspan="9" align="left"><input class='check-one check_all' type='checkbox' />全选<a href="javascript:;" class="sellbutton downall">下架</a></th></tr>
                        ...
                        <tbody>
                        <?php  $res=ProductList('(2)',$_SELLER->SellerId); echo  VwList($res,$template)?> 
...
$('.del').click(function(){
	...
	$.post("<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=downgoods';?>",{Id:id},function(date){
...
$('.downall').click(function(){
				...
				if(data.length > 0){
					$.post('<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=downgoods';?>',{'Id':data}, function (date) {	
