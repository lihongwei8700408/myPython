<?php
	...
	$del = WEB_SHOPADMIN.'/index.php?c=addproduct&other=deletebusiness';
	$template="
 		<tr>
		...
		<a class='del' href='javascript:;' data-id=<!--{VmSContent('Id[11]',\$vm_data)}-->>删除</a></td>
    	</tr>";
           ...
           <div class="userRight">
                <div class="uRight_user">
				   <div class="user_Eva_botTab">
                            ...
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=selleroffproductadmin'?>">手动下架</a>
                            <a href="<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=autooffproductadmin'?>" class="curr">售完下架</a>		
                    </div>
					<div class="userTitle">
                    	<span>售完下架</span>
                    </div>
                    ...
                    <table class="bought_table" id="businesstable">
                        ...
                        <tbody>
                        <?php  $res=ProductList('(3)',$_SELLER->SellerId); echo  VwList($res,$template)?> 
...
$('.del').click(function(){
	...
	$.post("<?php echo WEB_SHOPADMIN.'/index.php?c=mallproductadmin&other=deletegoods';?>",{Id:id},function(date){
