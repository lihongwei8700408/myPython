...
<style>
#coupondefault{width:500px;height:200px;background:#fff; position:fixed;left:42%;top:28%; border-radius:5px;padding:30px;display:none;z-index:101;border:5px solid #ddd;}
#coupondefault ul{margin:10px 20px;}
#coupondefault ul li{float:left;width:100px; height:100px; border:1px solid;margin-left:10px;}
</style>
<div class="content" style="margin-left:10px;">

           <div class="cLineB" style="width:800px;"><h4>添加代金券</h4></div>
          <form  name="form" method="post" action="<?php echo WEB_SHOPADMIN.'/index.php?c=addmallcoupon';?>" enctype="multipart/form-data" onSubmit="getContent()">
          <div class="msgWrap">
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                ...
                <tr><th></th>
				<td><a><button type="button" class="btnGreen addother">使用默认模板图片</button></a></td>
				</tr>
				<div id="coupondefault" >
					<ul>
						<li><img src=""/></li>
						<li><img src=""/></li>
						<li><img src=""/></li>
				...
				<tr>
                  ...
                  <td><input type="number" name="Worth" value="<?php if(isset($update)) echo $update->Worth;?>" class="px" tabindex="1" size="25" placeholder="面值（最多8位）"  >
                ...
                <tr>
                 ...
                 <tr>
                  <th><span class="red">*</span>使用期限：</th>
                  <td><input type="date" required="" name="StartTime" value="<?php if(isset($update)) echo date('Y-m-d',$update->StartTime);?>" class="px" tabindex="1" size="25"><span>&nbsp;至&nbsp;</span></span><input type="date" required="" name="EndTime" value="<?php if(isset($update)) echo date('Y-m-d', $update->EndTime);?>" class="px" tabindex="1" size="25"></td>
                </tr>
				 <tr>
